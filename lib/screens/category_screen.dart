...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  Widget _buildCategoryCard(BuildContext context, Map<String, String> item) {
    IconData getIcon() {
      if (widget.category.contains('Hospital')) return Icons.local_hospital;
      if (widget.category.contains('Pharmacies')) return Icons.local_pharmacy;
      if (widget.category.contains('Doctors')) return Icons.person;
      if (widget.category.contains('Laboratories')) return Icons.science;
