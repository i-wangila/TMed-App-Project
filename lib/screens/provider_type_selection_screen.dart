...
class _ProviderTypeSelectionScreenState
  ...
  Widget _buildCategoryTab(String title, String subtitle, int index) {
    final isSelected = _selectedCategoryIndex == index;
    return GestureDetector(
      onTap: () {
        setState(() {
          _selectedCategoryIndex = index;
          _selectedProviderType = null; // Reset selection when category changes
        });
      },
      child: Container(
  ...
  Widget _buildProviderTypesList() {
    final providerTypes = _selectedCategoryIndex == 0
        ? ProviderTypeService.getIndividualProviders()
        : ProviderTypeService.getFacilityProviders();
