...
class _DocumentManagementScreenState extends State<DocumentManagementScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          if (pendingDocs.isNotEmpty) ...[
            ...
            SizedBox(height: ResponsiveUtils.getResponsiveSpacing(context, 12)),
            ...pendingDocs.map((doc) => _buildDocumentCard(doc)),
            SizedBox(height: ResponsiveUtils.getResponsiveSpacing(context, 24)),
          ],

          if (rejectedDocs.isNotEmpty) ...[
            _buildSectionHeader('Rejected', Colors.red, rejectedDocs.length),
            SizedBox(height: ResponsiveUtils.getResponsiveSpacing(context, 12)),
            ...rejectedDocs.map((doc) => _buildDocumentCard(doc)),
            SizedBox(height: ResponsiveUtils.getResponsiveSpacing(context, 24)),
          ],

          if (approvedDocs.isNotEmpty) ...[
            _buildSectionHeader('Approved', Colors.green, approvedDocs.length),
            SizedBox(height: ResponsiveUtils.getResponsiveSpacing(context, 12)),
  ...
  Widget _buildStatsCards() {
    final stats = DocumentService.getDocumentStats();
