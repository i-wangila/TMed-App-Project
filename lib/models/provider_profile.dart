...
class BusinessPremises {
  ...
  List<String> images;
  String? description;
  Map<String, String> operatingHours; // day: hours
  ...
  BusinessPremises({
    ...
    this.latitude,
    this.longitude,
  }) : id = id ?? 'premises_${DateTime.now().millisecondsSinceEpoch}',
  ...
  factory BusinessPremises.fromJson(Map<String, dynamic> json) {
    return BusinessPremises(
      id: json['id'],
      name: json['name'] ?? '',
      address: json['address'] ?? '',
      city: json['city'] ?? '',
      country: json['country'] ?? 'Kenya',
      phone: json['phone'] ?? '',
      email: json['email'] ?? '',
...
class ProviderProfile {
  ...
  // Business Premises (for institutions or individual with office)
  ...
  factory ProviderProfile.fromJson(Map<String, dynamic> json) {
    return ProviderProfile(
      ...
      premises: json['premises'] != null
          ? BusinessPremises.fromJson(json['premises'])
          : null,
