...
class ProviderService {
  ...
  static List<ProviderProfile> searchProviders(String query) {
    ...
    return _providers.values.where((p) {
      ...
      return p.specialization?.toLowerCase().contains(lowerQuery) == true ||
          ...
          p.premises?.name.toLowerCase().contains(lowerQuery) == true ||
          p.premises?.city.toLowerCase().contains(lowerQuery) == true;
    }).toList();
  }
  ...
  // Update business premises
  static Future<bool> updatePremises(
    String providerId,
    ...
    try {
      ...
      _providers[providerId] = provider.copyWith(premises: premises);
      await _saveProviders();

      if (kDebugMode) {
        print('Premises updated for provider: $providerId');
      }

      return true;
    } catch (e) {
      if (kDebugMode) {
        print('Error updating premises: $e');
      }
      return false;
    }
  }
  ...
  static List<ProviderProfile> getProvidersByCity(String city) {
    return _providers.values
        .where(
          (p) =>
              p.isVerified &&
              p.premises?.city.toLowerCase() == city.toLowerCase(),
        )
        .toList();
  }
  ...
  static String getProviderDisplayName(String providerId) {
    ...
    return provider.premises?.name ?? user.name;
  }
  ...
  static String getProviderEmail(String providerId) {
    ...
    return provider.premises?.email ?? user.email;
  }
  ...
  static String getProviderPhone(String providerId) {
    ...
    return provider.premises?.phone ?? user.phone;
  }
